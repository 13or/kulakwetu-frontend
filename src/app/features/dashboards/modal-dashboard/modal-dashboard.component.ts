...
@Component({
  ...
  imports: [FormsModule,RouterLink,NgApexchartsModule,DateRangePickerComponent,MatSelectModule]    
})
...
page = '';
  ...
  constructor( private common: CommonService,private layout:SettingsService) {
      ...
      this.common.page.subscribe((res: string) => {
        this.page = res;
      if (this.page === 'layout-horizontal'){
        layout.changeLayoutMode('horizontal');
        layout.changeThemeColor('light');
      }else if (this.page === 'layout-detached'){
        layout.changeLayoutMode('detached');
        layout.changeThemeColor('light');
      }else if (this.page === 'layout-two-column'){
        sessionStorage.setItem('menuValue2', 'Layouts');
        layout.changeLayoutMode('twocolumn');
        layout.changeThemeColor('light');
      }else if (this.page === 'layout-rtl'){
        layout.changeLayoutMode('rtl');
        layout.changeThemeColor('light');
      }else if (this.page === 'layout-boxed'){
        layout.changeLayoutWidth('box');
        layout.changeThemeColor('light');
        layout.changeLayoutMode('default');
      }else if (this.page === 'layout-hovered'){
        layout.changeLayoutMode('layout-hovered');
        layout.changeThemeColor('light');
      }else if (this.page === 'layout-dark'){
        layout.changeThemeColor('dark');
        layout.changeLayoutWidth('fluid');
        layout.changeLayoutMode('default');
      }else {
